...
import { FaStar, FaShoppingCart, FaCheckCircle, FaBookOpen, FaCalendarAlt, FaUser, FaBuilding, FaBookmark, FaBarcode, FaTag, FaInfoCircle } from "react-icons/fa";
...
export const Bookdetail = () => {
  ...
  const addRatings = async (currentRating) => {
    ...
    try {
      ...
      fetchAverageRating(); // Update average rating after successfully adding the rating
    } catch (error) {
        ...
        <div className="bookdetails-container">
          ...
          <div className="book-data">
            ...
            <div className="book-info-grid">
              <p>
                <b><FaUser /> Author :&nbsp;</b> {book.Author}
              </p>
              <p>
                <b><FaBookOpen /> Edition :&nbsp;</b> {book.Edition || "Standard"}
              </p>
              <p>
                <b><FaCalendarAlt /> Published :&nbsp;</b> {formatDate(book.Publication_Date)}
              </p>
              <p>
                <b><FaBuilding /> Publisher :&nbsp;</b> {book.Publisher}
              </p>
              <p>
                <b><FaBarcode /> ISBN Number :&nbsp;</b> {book.ISBN}
              </p>
            </div>
            ...
            <div className="price-btn">
              ...
              <button className="buynow-btn" onClick={buynow}><FaCheckCircle /> Buy Now</button>
              <button className="addtocart-btn" onClick={addtocart}><FaShoppingCart /> Add To Cart</button>
            </div>
          </div>
        </div>
      </div>
